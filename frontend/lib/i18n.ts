...
const dict: Record<string, Record<Lang, string>> = {
  ...
  // ── Design preview (JARVIS-D1, Prototyp ohne echte Daten) ─────────────────────
  "design_preview.badge":            { en: "Prototype",   de: "Prototyp" },
  "design_preview.banner":           { en: "Design draft for JARVIS-D1 — no real API calls, no real data. Not linked in navigation.", de: "Gestaltungsentwurf für JARVIS-D1 — keine echten API-Aufrufe, keine echten Daten. Nicht in der Navigation verlinkt." },
  "design_preview.state_label":      { en: "State",       de: "Zustand" },
  "design_preview.state.empty":      { en: "Empty",       de: "Leer" },
  "design_preview.state.short":      { en: "Short thread", de: "Kurzer Verlauf" },
  "design_preview.state.long":       { en: "Long thread", de: "Langer Verlauf" },
  "design_preview.state.loading":    { en: "Loading",     de: "Lädt" },
  "design_preview.state.error":      { en: "Error",       de: "Fehler" },
  "design_preview.sources_hit":      { en: "Sources used", de: "Verwendete Quellen" },
  "design_preview.sources_base":     { en: "Base context", de: "Basiskontext" },
  "design_preview.sources_base_hint": { en: "Always sent along, but did not itself carry this answer.", de: "Immer mitgesendet — hat diese Antwort aber nicht selbst getragen." },
  "design_preview.actions_title":    { en: "Suggested work orders", de: "Auftragsvorschau" },
  "design_preview.actions_hint":     { en: "Pure design — the command layer doesn't exist yet. Nothing here creates anything.", de: "Reine Gestaltung. Der Command Layer existiert noch nicht — nichts hier legt etwas an." },
  "design_preview.actions_unavailable": { en: "Not available yet", de: "Noch nicht verfügbar" },
  "design_preview.detail_title":     { en: "Details",     de: "Details" },
  "design_preview.detail_empty":     { en: "Select a source or work order to see details.", de: "Quelle oder Auftrag auswählen, um Details zu sehen." },
  "design_preview.tokens_title":     { en: "Design tokens", de: "Design-Tokens" },
  "design_preview.tokens_accent_before": { en: "Before (Phase 2, too dark)", de: "Vorher (Phase 2, zu dunkel)" },
  "design_preview.tokens_accent_after":  { en: "Now (corrected)", de: "Jetzt (korrigiert)" },
  "design_preview.risk_low":         { en: "Low risk",    de: "Niedriges Risiko" },
  "design_preview.risk_medium":      { en: "Medium risk", de: "Mittleres Risiko" },
  "design_preview.risk_high":        { en: "High risk",   de: "Hohes Risiko" },
  "design_preview.requires_approval": { en: "Needs approval", de: "Braucht Freigabe" },
  "design_preview.no_approval":      { en: "No approval needed", de: "Keine Freigabe nötig" },
