...
const dict: Record<string, Record<Lang, string>> = {
  ...
  "dashboard.project_cards.next_action_label": { en: "Next task",          de: "Nächste Aufgabe" },
  ...
  "dashboard.project_cards.updated_today":     { en: "As of: today",       de: "Stand: heute" },
  "dashboard.project_cards.updated_one_day":   { en: "As of: 1 day ago",   de: "Stand: vor 1 Tag" },
  "dashboard.project_cards.updated_days":      { en: "As of: {n} days ago", de: "Stand: vor {n} Tagen" },
  "dashboard.project_cards.stale_hint":        { en: "Not updated recently", de: "Länger nicht aktualisiert" },
