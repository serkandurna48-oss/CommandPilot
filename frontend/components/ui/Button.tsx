...
const variants = {
  ...
  secondary:
    "bg-[var(--interactive-bg-secondary-default)] hover:bg-[var(--interactive-bg-secondary-hover)] active:bg-[var(--interactive-bg-secondary-press)] text-[var(--text-primary)] border-[var(--border-default)]",
  ghost:
    "bg-transparent hover:bg-[var(--interactive-bg-secondary-hover)] active:bg-[var(--interactive-bg-secondary-press)] text-[var(--text-secondary)] border-transparent",
